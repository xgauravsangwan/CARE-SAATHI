...
public class AddDoctor extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("INSERT INTO doctor (fname, lname, gender, mobile, city, email, age, address, date, qualification, specialization) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
