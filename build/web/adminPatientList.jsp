                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column10">Mobile</th>
                            ...
                            <table>
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column5"><%=rs.getString("city")%></td>
                                        <td class="cell100 column6"><%=rs.getString("email")%></td>
                                        <td class="cell100 column7"><%=rs.getString("age")%></td>
                                        <td class="cell100 column8"><%=rs.getString("address")%></td>
                                        <td class="cell100 column9"><%=rs.getString("date")%></td>
                                        <td class="cell100 column10"><%=rs.getString("mobile")%></td>
                                        <td class="cell100 column11">
                                            <a href="updatePatient.jsp?id=<%=id%>">Edit</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
