<%-- 
    Document   : doctor_medical_records
    Created on : Apr 21, 2024, 2:27:42 AM
    Author     : Gaurav
--%>
            ...
            <div class="table100 ver3 m-b-110">
                <div class="table100-head">
                    <table>
                        ...
                        <tr class="row100 head">
                            ...
                            <th class="cell100 column3">Patient Remarks</th>                            
                            <th class="cell100 column4">Age</th>
                            <th class="cell100 column5">Blood Group</th>
                            <th class="cell100 column6">Gender</th>
                            <th class="cell100 column7">Previous Health Problems</th>
                            <th class="cell100 column8">Disease</th>
                            <th class="cell100 column9">Test Name</th>
                            <th class="cell100 column10">Test Date</th>
                        </tr>
                        </thead>
                    </table>
                </div>
                <%
                            try {
                                ...
                                String sql = "SELECT a.*, d.Disease, d.test_name, d.test_date " +
                                "FROM appointments a " +
                                "LEFT JOIN diagnosis d ON a.patient_id = d.patient_id " +
                ...
                <div class="table100-body js-pscroll">
                    <table>
                        ...
                        <tr class="row100 body">
                            <td class="cell100 column1"><%=rs.getString("patient_id")%></td>
                            <td class="cell100 column2"><%=rs.getString("patient_name")%></td>
                            <td class="cell100 column3"><%=rs.getString(8)%></td>
                            <td class="cell100 column4"><%=rs.getString(11)%></td>
                            <td class="cell100 column5"><%=rs.getString("blood_group")%></td>
                            <td class="cell100 column6"><%=rs.getString("gender")%></td>
                            <td class="cell100 column7"><%=rs.getString("previous_health_problems")%></td>
                            <td class="cell100 column8"><%=rs.getString("Disease")%></td>
                            <td class="cell100 column9"><%=rs.getString("test_name")%></td>
                            <td class="cell100 column10"><%=rs.getString("test_date")%></td>
                        </tr>
                        </tbody>
                        <%
                                }
