<%-- 
    ...
    Created on : Apr 21, 2024, 12:38:13 AM
    Author     : Gaurav
--%>
            ...
            <div class="table100 ver3 m-b-110">
                <div class="table100-head">
                    <table>
                        ...
                        <tr class="row100 head">
                            <th class="cell100 column1">Lab Result Id</th>
                            <th class="cell100 column2">Test Name</th>
                            <th class="cell100 column3">Test Date</th>
                            <th class="cell100 column4">Patient Id</th>
                            <th class="cell100 column5">Result</th>
                ...
                <%
                            try {
                                ...
                                if (query != null) {
                                sql = "SELECT * FROM lab_results WHERE patient_id = " + patientId;
                                } else {
                                    sql = "SELECT * FROM lab_results WHERE patient_id = " + patientId;
                                }
                ...
                <div class="table100-body js-pscroll">
                    <table>
                        ...
                        <tr class="row100 body">
                            ...
                            <td class="cell100 column5"><%=rs.getString(4)%></td>                            
                        </tr>
                        </tbody>
                        <%
                                }
