<%-- 
    ...
    Created on : Apr 30, 2024, 12:19:34 AM
    Author     : Gaurav
--%>
    ...
    <div class="wrap-contact100">
        <div class="contact100-form-title" style="background-image: url(img/bg-01.jpg);">
            <span class="contact100-form-title-1">
                Doctor Prescribing Form
            </span>				
        </div>
        <form class="contact100-form validate-form" action="<%=request.getContextPath()%>/AddPrescriptions" method="post">
            ...
            <div class="wrap-input100 validate-input" data-validate="Valid Medicine is required">
                <span class="label-input100">Prescriptions:</span>
                <input class="input100" type="text" name="prescription" placeholder="Enter prescription">
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input" data-validate="Valid Medication is required">
                <span class="label-input100">Medications:</span>
                <input class="input100" type="text" name="medication" placeholder="Enter medication">
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input" data-validate="Valid therapy is required">
                <span class="label-input100">Therapy:</span>
                <input class="input100" type="text" name="therapy" placeholder="Enter therapy">
                <span class="focus-input100"></span>
            </div>
