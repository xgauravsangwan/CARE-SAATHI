                ...
                <div class="table200-head">
                    <table>
                        ...
                        <tr class="row100 head">
                            ...
                            <th class="cell100 column9">Blood Group</th>
                            <th class="cell100 column10">Patient Remarks</th>
                            <th class="cell100 column11">Previous Health Problems</th> 
                        </tr>
                        </thead>
                    </table>
                </div>
                ...
                <div class="table100-body js-pscroll">
                    <table>
                        ...
                        <tr class="row100 body">
                            ...
                            <td class="cell100 column3"><%=rs.getString(7)%></td>
                            <td class="cell100 column4"><%=rs.getString(12)%></td>
                            <td class="cell100 column5"><%=rs.getString(11)%></td>
                            <td class="cell100 column6"><%=rs.getString(13)%></td>
                            <td class="cell100 column7"><%=rs.getString(10)%></td>
                            <td class="cell100 column8"><%=rs.getString(14)%></td>
                            <td class="cell100 column9"><%=rs.getString(15)%></td>
                            <td class="cell100 column10"><%=rs.getString(8)%></td>
                            <td class="cell100 column11"><%=rs.getString(9)%></td>
                        </tr>
                        </tbody>
                        <%
                                }
