<%-- 
    Document   : updateRecp
    Created on : Nov 6, 2024, 1:56:23 PM
    Author     : Gaurav
--%>
...
<%
            ...
            String s = "SELECT * FROM recp WHERE recp_id = '"+id+"' ";
...
<div class="container-contact100">
    <div class="wrap-contact100">
        ...
        <form class="contact100-form validate-form" action="<%=request.getContextPath()%>/updateRecp" method="post">
            <input type="hidden" name="recp_id" value="<%= id %>">
