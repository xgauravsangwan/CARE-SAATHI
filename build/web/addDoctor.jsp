            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="<%=request.getContextPath()%>/AddDoctor" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Phone is required">
                        ...
                        <input class="input100" type="text" name="mobile" placeholder="Enter phone number" pattern="\d{10}" title="Please enter a 10-digit phone number" maxlength="10" required>
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="specialisation is required">
                        <span class="label-input100">Specialization</span>
                        <input class="input100" type="text" name="specialization" placeholder="Enter Specialization">
                        <span class="focus-input100"></span>
                    </div>
