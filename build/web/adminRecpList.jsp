    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a href="#" class="navbar-brand"> <img src="img/CS_Logo.jpg"
                                                   height="100" width="100" alt="HospitalManagementSystem">
            </a>
                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        <th class="cell100 column1">Recp Id</th>
                                        ...
                                        <th class="cell100 column9">Email</th>
                                        <th class="cell100 column10">Qualification</th>
                                        <th class="cell100 column11">Date of Joining</th>
                                        <th class="cell100 column12">Action</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                            ...
                            <table>
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column11"><%=rs.getString(11)%></td>
                                        <td class="cell100 column12">
                                            <a href="updateRecp.jsp?id=<%=id%>">Edit</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="deleteRecp.jsp?mob=<%=mob%>">Delete</a>
                                        </td>
                                    </tr>
                                </tbody>
                                <%
