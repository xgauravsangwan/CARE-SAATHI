<%-- 
    ...
    Created on : Apr 30, 2024, 10:54:45 PM
    Author     : Gaurav
--%>
...
<%
            ...
            String s = "SELECT * FROM doctor WHERE id = '"+id+"' ";
...
<div class="container-contact100">
    <div class="wrap-contact100">
        ...
        <form class="contact100-form validate-form" action="<%=request.getContextPath()%>/updateDoctor" method="post">
            ...
            <div class="wrap-input100 validate-input" data-validate="Updated ID is required">
                <span class="label-input100">Unique ID:</span>
                <input class="input100" type="text" value="<%= rs.getString("id") %>" name="id" placeholder="Enter Unique Updated ID">
