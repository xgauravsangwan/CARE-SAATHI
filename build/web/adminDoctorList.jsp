                    ...
                    <div class="table100 ver3 m-b-110">
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from doctor where fname like '%" + query + "%' or lname like '%" + query + "%' or mobile LIKE '%" + query + "%'";
                                } else {
                            ...
                            <table>
                                <tbody>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column12"><%=rs.getString(12)%></td>
                                        <td class="cell100 column13">
                                        <td>
                                            <a href="updateDoctor.jsp?id=<%=id%>">Edit</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="deleteDoctor.jsp?mob=<%=mob%>">Delete</a>
                                        </td>
                                    </tr>
                                </tbody>
                                <%
